...
#ifndef DATA_GENERATOR_DATABASE_DRIVER_ORACLE_DRIVER_H
#define DATA_GENERATOR_DATABASE_DRIVER_ORACLE_DRIVER_H

#include "database/driver/idatabase_driver.h"

namespace data_generator::database {

class OracleDriver final : public IDatabaseDriver {
public:
