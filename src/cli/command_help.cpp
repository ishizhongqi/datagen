...
int CommandHelp::run(const std::vector<std::string>& /*args*/) {
    std::cout << "data-generator CLI\n"
              ...
              << "  data-generator init --output-dest database --url \"odbc:mysql:DRIVER={MySQL ODBC 8.0 Unicode Driver};SERVER=127.0.0.1;PORT=3306;DATABASE=example_db;UID=user;PWD=password;\" --table t_orders\n"
              ...
              << "  data-generator generate --input config.json --output-dest database --url \"odbc:postgresql:DRIVER={PostgreSQL Unicode};SERVER=127.0.0.1;PORT=5432;DATABASE=db;UID=u;PWD=p;\" --table t_orders\n"
              << "  data-generator drivers --json\n"
