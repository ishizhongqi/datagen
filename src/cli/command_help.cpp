...
int CommandHelp::run(const std::vector<std::string>& /*args*/) {
    std::cout << "data-generator CLI\n"
              ...
              << "\n"
              << "Command usage:\n"
              << "  data-generator init <json> [--template file|database] [--format <format>] [--from-database <connection>] [--table <name>]\n"
              ...
              << "  data-generator init template.json --template database --from-database \"odbc://DRIVER={MySQL ODBC 8.0 Driver};SERVER=127.0.0.1;PORT=3306;DATABASE=example_db;UID=user;PWD=password;\" --table t_orders\n"
